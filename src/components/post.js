...
// import { firestore } from "../configuration/firebase"; // Adjust the path as necessary
...
//                  <form onSubmit={handleSubmit} action="" className="flex flex-col items-center gap-[20px] pt-10 pb-10" >
